...
ATOM(char, rhizome_mdp,		        0, cf_opt_char_boolean,, "")
ATOM(char, rhizome_ads,		        0, cf_opt_char_boolean,, "")
ATOM(char, rhizome_async,               0, cf_opt_char_boolean,, "")
ATOM(char, manifests,		        0, cf_opt_char_boolean,, "")
ATOM(char, vomp,		        0, cf_opt_char_boolean,, "")
ATOM(char, mdp_simulated_loss,          0, cf_opt_char_boolean,, "")
END_STRUCT
...
ATOM(uint64_t,max_size,1024, cf_opt_uint64_scaled,,"Sets larged bundle payload size that will be transported by this channel.")
...
ATOM(uint64_t,              buffer_size, 1024*1024, cf_opt_uint64_scaled,, "Maximum receive buffer size in bytes")
