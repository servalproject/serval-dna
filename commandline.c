...
struct command_line_option command_line_options[]={
  ...
  {app_rhizome_direct_async_check,{"rhizome","direct","async","scan",NULL},
   CLIFLAG_STANDALONE,
   "Scan Rhizome Direct Async channel in-bound spool directories for new content."},
  {app_rhizome_direct_async,{"rhizome","direct","async","dispatch","[<message bytes>]","[<max messages>]","[<token>]",NULL},
   CLIFLAG_STANDALONE,
